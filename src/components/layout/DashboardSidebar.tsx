          ...
          <Link to="/dashboard" className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="overflow-hidden">
                <h1 className="text-sm font-bold text-sidebar-primary-foreground tracking-tight leading-none">MediCare</h1>
                <p className="text-[9px] uppercase tracking-[0.15em] text-sidebar-foreground/50 font-semibold mt-0.5">
                  {userRole || "Staff"}
                </p>
              </div>
            )}
