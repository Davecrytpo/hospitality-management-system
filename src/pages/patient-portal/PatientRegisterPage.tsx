        ...
        <div className="w-full max-w-[760px]">
          ...
          <Card className="rounded-[28px] border border-[#dbe4f4] bg-white shadow-[0_28px_60px_-34px_rgba(19,48,107,0.35)]">
            ...
            <CardContent className="space-y-5">
              ...
              {needsSupport && (
                <div className="rounded-2xl border border-[#dbe4f4] bg-[#f8fbff] p-4 text-sm font-medium text-[#13306b]">
                  Don&apos;t have the correct invitation ID or verification code? Call <a href="tel:+14107544343" className="font-extrabold text-[#ef2027]">410-754-4343</a> or contact support so the team can verify your details securely.
                </div>
              )}
