...
const severityColors = { critical: "destructive", severe: "secondary", moderate: "outline", mild: "outline" };
              ...
              <CardContent className="pt-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant={(severityColors as any)[c.triage]}>{c.triage.toUpperCase()}</Badge>
